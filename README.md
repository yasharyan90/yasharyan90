...
<img src="./contrib-heatmap.svg" width="860" alt="Yash's GitHub contribution graph — auto-refreshed daily" />
...
<table>
<tr>
<td valign="top"><img src="./ascii-portrait.svg" width="400" alt="Yash Aryan — ASCII portrait" /></td>
<td valign="top"><img src="./info-card.svg" width="460" alt="Yash Aryan — education, stack, highlights" /></td>
</tr>
</table>
...
<div align="center">
<sub>👇 the fuller profile — about me, tech stack, projects, certifications 👇</sub>
</div>
...
[1;33mContact.LinkedIn[0m[90m....[0m www.linkedin.com/in/yasharyan90/
...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=800&color=06B6D4&center=true&vCenter=true&width=600&lines=Cloud+Computing+%26+Automation+Enthusiast;Full+Stack+Web+Developer;Docker+%2B+Kubernetes+%2B+AWS;Competitive+Programmer+%7C+250%2B+DSA+Solved;Always+Building%2C+Always+Learning" alt="Typing SVG" />
</a>
...
<img align="right" alt="Coding GIF" width="330" src="https://raw.githubusercontent.com/mishakorzik/mishakorzik/main/coding.gif">

### 🧑‍💻 About Me

- 🎓 B.Tech in Computer Science (Cloud Computing & Automation) @ **VIT Bhopal** — Expected 2028
- ☁️ Passionate about **Cloud-Native architectures**, DevOps, and scalable full-stack systems
- 🛠️ Currently building projects with **Docker, Kubernetes, React & Node.js**
- 📊 Solved **250+ DSA problems** across LeetCode & GeeksforGeeks
- 📚 Actively following **Striver's A2Z DSA Sheet**
- ⚡ Fun fact: I enjoy turning messy backend infrastructure into clean, orchestrated systems
...
<img src="https://img.shields.io/badge/EC2%20%7C%20S3%20%7C%20DynamoDB-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white"/>
</p>
...
**🏥 [Unified Health Intelligence Platform (UHIP)](https://github.com/yasharyan90)**  
Cloud-native healthcare platform · Team Project  
`Docker` `Docker Compose` `Node.js` `Express` `React` `Vite` `PostgreSQL` `MongoDB` `FastAPI`
- Led Docker-based deployment & containerization across React, Express, FastAPI, PostgreSQL & MongoDB services
- Configured orchestration, networking, storage volumes & environment variables via Docker Compose
- 🏆 Earned **S Grade**, presented at College Project Exhibition

</td>
<td width="50%" valign="top">

**💎 [Aurum Luxury Boutique](https://aurum-luxury-ecom-store-main-store-six.vercel.app/)**  
Full-Stack E-Commerce Platform · Personal Project  
`React.js` `Supabase` `PostgreSQL` `Razorpay` `EmailJS` `CSS Modules`
- Dual-auth, RBAC & Supabase RLS for a hardened, secure architecture
- Live Razorpay checkouts with GST calculation + automated EmailJS order confirmations
- Real-time Owner Dashboard & customer tracking portal via Supabase Realtime
...
**✅ [Advanced Todo Application](https://updated-todo-app-eta.vercel.app/)**  
Personal Project  
`JavaScript` `HTML` `CSS` `Local Storage`
- Task management, calendar planning & dark-mode Pomodoro timer
- Persistent data retention via modular, scalable Local Storage architecture

</td>
<td width="50%" valign="top">

**📈 More on the way...**  
Currently exploring deeper Kubernetes orchestration and AI-agent based tooling.  
Check my [pinned repos →](https://github.com/yasharyan90?tab=repositories)
...
- ☁️ **Cloud Computing and Distributed Systems** — Elite + Silver (NPTEL, 78%)
- 📡 **Introduction to Internet of Things** — Elite (NPTEL, 77%)
- ⚙️ **Manage Kubernetes in Google Cloud** — Google Cloud Skill Badge
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=yasharyan90&show_icons=true&theme=tokyonight&hide_border=true&count_private=true"/>
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=yasharyan90&layout=compact&theme=tokyonight&hide_border=true"/>

<img src="https://github-readme-streak-stats.herokuapp.com/?user=yasharyan90&theme=tokyonight&hide_border=true" alt="streak stats"/>

<img src="https://github-readme-activity-graph.vercel.app/graph?username=yasharyan90&theme=tokyo-night&hide_border=true" width="100%"/>
...
I'm always open to interesting projects in **cloud infrastructure, full-stack development, or DevOps automation**. Feel free to reach out!

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:06B6D4,100:6D28D9&height=100&section=footer" width="100%"/>

![Profile Views](https://komarev.com/ghpvc/?username=yasharyan90&color=6D28D9&style=flat-square&label=Profile+Views)
