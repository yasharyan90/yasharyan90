...
ROWS = [
    ("host",),
    ("kv", "Status", "B.Tech CS Student @ VIT Bhopal"),
    ("kv", "Track", "Cloud Computing & Automation"),
    ("kv", "Grad", "Expected 2028"),
    ("kv", "Focus", "Cloud-native & Full-stack Dev"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, C++, Python, SQL, JS"),
    ("kv", "Web", "React.js, Node.js, Express.js"),
    ("kv", "Cloud", "Docker, Kubernetes, AWS"),
    ("kv", "Database", "MongoDB, MySQL, PostgreSQL"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "250+ DSA problems solved (LeetCode + GFG)"),
    ("bul", "Shipped 3 full-stack / cloud-native projects"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">yash@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">yash</tspan><tspan fill="{MUTED}">@</tspan>'
